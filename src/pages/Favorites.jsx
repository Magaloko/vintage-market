      ...
      <div style={{ backgroundColor: 'rgba(44, 36, 32, 0.04)' }}>
        <div className="max-w-7xl mx-auto px-6 pt-28 pb-16">
          ...
          <p className="font-body text-lg" style={{ color: 'rgba(28, 28, 26, 0.5)' }}>
            {favoritesCount > 0
              ? `${favoritesCount} ${pluralize(favoritesCount)} в вашей коллекции`
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-8">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="animate-pulse">
                ...
                />
                <div
                  className="mt-4 h-4 rounded w-3/4"
                  style={{ backgroundColor: 'rgba(44, 36, 32, 0.06)' }}
                />
                <div
                  className="mt-2 h-4 rounded w-1/4"
                  style={{ backgroundColor: 'rgba(44, 36, 32, 0.06)' }}
                />
              </div>
            ))}
        ...
        {!loading && products.length === 0 && (
          <div className="text-center py-20">
            ...
            >
              Нажмите на сердечко рядом с товаром, чтобы добавить его в избранное. Так вы
              не потеряете понравившиеся находки.
            </p>

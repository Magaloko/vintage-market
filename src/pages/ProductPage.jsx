...
import { ArrowLeft, Eye, Calendar, Tag, Ruler, Clock, Package } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="relative">
            <div className="aspect-square overflow-hidden bg-vintage-beige/30 sticky top-24">
              <img
              ...
              />
              {product.status === 'sold' && (
                <div className="absolute inset-0 bg-vintage-dark/50 flex items-center justify-center">
          ...
          <div>
            ...
            <h1 className="font-display text-3xl md:text-4xl font-bold text-vintage-dark leading-tight mb-4">
              {product.title}
            </h1>

    ...
    <div className="max-w-3xl mx-auto animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <h3 className="font-sans text-sm font-medium text-gray-900 mb-4">Изображение</h3>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1">
              <label className="block font-sans text-xs text-gray-400 mb-2">URL изображения</label>
              <input
                type="url"
                name="image_url"
                value={form.image_url}
                onChange={handleChange}
                placeholder="https://... или GitHub raw link"
              ...
              <p className="font-sans text-xs text-gray-400 mt-2">
                Вставьте ссылку на изображение (Unsplash, GitHub Raw, любой URL)
              </p>
            </div>
          </div>
        </div>

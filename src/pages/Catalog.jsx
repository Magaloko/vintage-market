  ...
  return (
    <div className="page-enter">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        {/* Top Bar: mobile filter toggle + category pills + sort */}
          ...
          <div className="relative ml-auto">
            ...
            {showSort && (
              <>
                ...
                <div
                  className="absolute right-0 top-full mt-2 shadow-vintage-lg z-20 min-w-[200px] py-2"
                  style={{
                ...
                >
                  {sortOptions.map((opt) => (
                    <button
                      ...
                      style={{
                        backgroundColor:
                          sortBy === opt.id ? 'rgba(44, 36, 32, 0.06)' : 'transparent',
        ...
        {/* Extended filters: price, condition, era */}
        <div className={`flex-wrap gap-3 mb-6 ${showFilters ? 'flex' : 'hidden md:flex'}`}>
          ...
          <div className="flex flex-wrap gap-1.5">
            {PRICE_RANGES.map((range) => (
              <button
                key={range.id}
                onClick={() =>
                  setActivePriceRange(activePriceRange === range.id ? 'all' : range.id)
                }
          ...
          <div
            ...
            style={{ backgroundColor: 'rgba(44, 36, 32, 0.1)' }}
          />
          ...
          <div className="flex flex-wrap gap-1.5">
            {conditions.map((cond) => (
              <button
                key={cond.id}
                onClick={() =>
                  setActiveCondition(activeCondition === cond.id ? '' : cond.id)
                }
                className="px-3 py-1.5 font-body text-xs rounded-full transition-all"
                style={{
                  backgroundColor:
                    activeCondition === cond.id ? 'rgba(176, 141, 87, 0.1)' : 'transparent',
          ...
          <div className="flex flex-wrap gap-1.5">
            {eras.map((era) => (
              <button
                ...
                style={{
                  backgroundColor:
                    activeEra === era.id ? 'rgba(176, 141, 87, 0.1)' : 'transparent',
          ...
          <div className="flex items-center gap-2 mb-6 text-sm">
            ...
            {activeFilterCount > 0 && (
              <button
                ...
                className="font-body text-xs ml-2 transition-colors"
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            <p className="font-display text-2xl mb-4" style={{ color: 'rgba(44, 36, 32, 0.25)' }}>
              Ничего не найдено
            </p>
              ...
              <div className="text-center mt-16">
                ...
                >
                  ...
                  <span className="ml-2 font-body text-xs" style={{ opacity: 0.5 }}>
                    ({Math.min(ITEMS_PER_PAGE, products.length - visibleCount)} из{' '}

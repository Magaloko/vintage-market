    ...
    <div className="page-enter">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                ...
                style={{ backgroundColor: 'rgba(44, 36, 32, 0.03)', borderRadius: '2px' }}
              >
                <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {shops.map((shop) => {
              const rating = Math.round(shop.rating || 0)
              return (
                <Link
                  key={shop.id}
                  to={`/shop/${shop.slug}`}
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = 'rgba(44, 36, 32, 0.06)'
                ...
                >
                  ...
                  {shop.logo_url ? (
                    ...
                    <div
                      className="w-14 h-14 rounded flex items-center justify-center font-display text-xl mb-4"
                      style={{
                  ...
                  <h3
                    className="font-display text-lg italic mb-1"
                    style={{ color: '#0C0A08' }}
                  >
                    {shop.name}
                  </h3>
                    ...
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((s) => (
                        <Star
                          key={s}
                          size={11}
                          fill={s <= rating ? '#B08D57' : 'none'}
                          style={{
                            color: s <= rating ? '#B08D57' : 'rgba(44, 36, 32, 0.15)',
                          }}
                        />
                      ))}
                    </div>
                  ...
                  <div
                    ...
                    style={{ borderTop: '1px solid rgba(44, 36, 32, 0.06)' }}
                  >
                    {shop.address && (
                      <span

      ...
      <div className="page-enter">
        <div className="py-16" style={{ backgroundColor: '#0C0A08' }}>
          <div className="max-w-7xl mx-auto px-6">
            <h1 className="font-display text-4xl font-bold" style={{ color: '#F0E6D6' }}>Сравнение</h1>
          </div>
    ...
    <div className="page-enter">
      <div className="py-16" style={{ backgroundColor: '#0C0A08' }}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div>
            <h1 className="font-display text-4xl font-bold" style={{ color: '#F0E6D6' }}>Сравнение товаров</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px]">
            ...
            <tbody>
              {rows.map((row, ri) => (
                <tr key={row.key} style={{ backgroundColor: ri % 2 === 0 ? 'rgba(44, 36, 32, 0.03)' : 'transparent' }}>
              ...
              {detailRows.map((row, ri) => (
                <tr key={row.key} style={{ backgroundColor: (rows.length + ri) % 2 === 0 ? 'rgba(44, 36, 32, 0.03)' : 'transparent' }}>
                  <td className="px-4 py-3 font-sans text-xs tracking-wider uppercase font-medium"
